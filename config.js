...
module.exports = {
	VERSION: 'v4.4.1', 
    SESSION_ID: process.env.SESSION_ID || '09_06_H_E_R_M_I_T_OI_2OSU',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Le Souverain Bot',
    ...
    AUDIO_DATA: process.env.AUDIO_DATA === undefined ? 'isshiki;ᴀᴅɪᴛʜyᴀɴ;https://i.imgur.com/fj2WE83.jpeg' : process.env.AUDIO_DATA,
    STICKER_DATA: process.env.STICKER_DATA === undefined ? 'isshiki;souverain' : process.env.STICKER_DATA,
    ...
    HEROKU: {
       ...
       SUDO: process.env.SUDO || '12103219065,18296417107,0',
       DEBUG: DEBUG
};
